...
namespace TheJourneyAhead
{
    class EscUI
    {
        ...
        public void Update(GameTime gameTime,int pPosX, int pPosY)
        {
            ...
            {                              
                save = new SaveLoad();
                save.Save(PlayerDetails.Instance.Area, PlayerDetails.Instance.Gender, PlayerDetails.Instance.Hair, PlayerDetails.Instance.HairColour, PlayerDetails.Instance.Skin, PlayerDetails.Instance.Head, PlayerDetails.Instance.Eye, PlayerDetails.Instance.EyeColour, PPosX, PPosY, PlayerDetails.Instance.AreaPosX, PlayerDetails.Instance.AreaPosY, PlayerDetails.Instance.PName, false, 0);
                savingText = true;
                if (save.Saved == true)
                {
